...
def callback(data):
    ...
    noisy_odom.pose.pose.position.z = 0
    (noisy_odom.pose.pose.orientation.x,noisy_odom.pose.pose.orientation.y,noisy_odom.pose.pose.orientation.z) = (0,0,pose[2])
    noisy_odom.header.stamp = rospy.Time.now()
...
if __name__ == '__main__':
    ...
    pub = rospy.Publisher('/noisy_odom', Odometry, queue_size=1)
    rospy.spin()
