...
echo_and_run cd "/home/himanshu/nav_sys/src/turtlebot3_autorace/turtlebot3_autorace_detect"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/himanshu/nav_sys/src/turtlebot3_autorace/turtlebot3_autorace_detect/setup.py" \
     \
    build --build-base "/home/himanshu/nav_sys/build/turtlebot3_autorace/turtlebot3_autorace_detect" \
    install \
    --root="${DESTDIR-/}" \
