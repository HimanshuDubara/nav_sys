...
echo_and_run cd "/home/himanshu/nav_sys/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/himanshu/nav_sys/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/himanshu/nav_sys/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
